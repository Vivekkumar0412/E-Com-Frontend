            ...
            <div className="flex items-start ">
              ...
              <div>
                ...
                <div className="flex items-center mt-2">
                  <button className="border rounded px-2 py-1 text-xl font-md">
                    +
                  </button>
                  <span className="mx-4"> {product.minimumOrderQuantity}</span>
                  <button className="border rounded px-2.5 py-1 text-xl font-md">
                    -
                  </button>
                </div>
              </div>
